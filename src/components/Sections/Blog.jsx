...
export const Blog = () => {
    ...
    return (
        <section data-slot="panel" className="screen-line-before screen-line-after border-x border-edge dark:border-white/10" id="blog">
            <header data-slot="panel-header" className="screen-line-after px-4 py-4 border-b border-edge dark:border-white/10">
                <h2 data-slot="panel-title" className="text-3xl font-semibold dark:text-white text-gray-900">Blog</h2>
            </header>
            ...
            <div className="screen-line-before flex justify-center py-2 border-t border-edge dark:border-white/10">
                <Link
                    data-slot="button"
