  ...
  return (
    ...
    >
      ...
      <div className="relative py-8">
        <div className="pointer-events-none absolute inset-0 -z-1 grid grid-cols-1 gap-4 max-sm:hidden lg:grid-cols-3">
          <div className="border-r border-edge dark:border-white/10"></div>
          <div className="lg:col-span-2 border-l border-edge dark:border-white/10"></div>
        </div>
